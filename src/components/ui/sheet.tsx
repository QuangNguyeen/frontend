...
const sideVariants: Record<SheetSide, string> = {
  ...
  left: "inset-y-0 left-0 h-[100dvh] w-[calc(100vw-1rem)] max-w-sm border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
  right: "inset-y-0 right-0 h-[100dvh] w-[calc(100vw-1rem)] max-w-sm border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
}
